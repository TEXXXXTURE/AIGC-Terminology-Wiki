# 来源: https://huggingface.co/learn/cookbook/enterprise_hub_serverless_inference_api
...
You are an expert prompt engineer with artistic flair.user

Write a concise prompt for a fun image containing a llama and a cookbook. Only return the prompt.assistant
...
prompt = prompt.replace("", image_input)
```
